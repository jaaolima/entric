									...
									<div class="ekit-twitter-feed-content-wraper">
										...
										<div class="ekit-twitter-feed-header">
											...
											<div class="ekit-twitter-logo">
												<a href="<?php echo esc_url('https://twitter.com/statuses/' . $twitter['id_str']); ?>" target="_blank"><i class="icon icon-twitter"></i></a>
											</div>
										</div>
										<?php endif;?>
										...
										if($ekit_twitter_feed_show_media == 'yes'):
											...
											<div class="ekit-twitter-media">
												<a href="<?php echo esc_url('https://twitter.com/statuses/' . $twitter['id_str']); ?>" target="_blank">
													<img src="<?php echo esc_url($media);?>" alt="<?php echo esc_html($user['name'] );?>" />
													<?php if($type == 'video') : ?>
														<!-- video content here -->
														<div class="video_content">
															<svg xmlns="http://www.w3.org/2000/svg" class="twitter_video_play_icon" viewBox="0 0 21.5 21.5"><circle cx="10.8" cy="10.8" r="10"/><path d="M14.8 10.3l-6-3.8c-.2-.1-.6-.1-.7.2-.1 0-.1.1-.1.2v7.6c0 .3.2.5.5.5.1 0 .2 0 .3-.1l6-3.8c.1-.1.2-.3.2-.4s-.1-.3-.2-.4z"/><path d="M10.8 21.5C4.8 21.5 0 16.7 0 10.8S4.8 0 10.8 0s10.8 4.8 10.8 10.8-4.9 10.7-10.8 10.7zm0-20c-5.1 0-9.3 4.2-9.3 9.3S5.7 20 10.8 20s9.3-4.1 9.3-9.3-4.2-9.2-9.3-9.2z"/></svg>
														</div>
														<!-- video content end -->
													<?php endif; ?>
												</a>
										...
										<div class="read-more-button">
											<a href="<?php echo esc_url('https://twitter.com/statuses/' . $twitter['id_str']); ?>" target="_blank"> <?php esc_html_e('More', 'elementskit'); ?> </a>
										</div>
										<?php endif;?>
										<!--End read more-->
										...
										<?php if($ekit_twitter_feed_comments_box == 'yes'): ?>
											<div class="ekit-twitter-feed-comments">
												<a href="<?php echo esc_url('https://twitter.com/intent/tweet?in_reply_to=' . $twitter['id_str'] . '&related=' . $user['screen_name']);?>" title="Comments" class="ekit-twitter-comments"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11.5 11.5"><path d="M4.6 0H7c1.3 0 2.4.4 3.2 1.3.9.9 1.3 2 1.3 3.2 0 .7-.2 1.3-.5 2-.3.6-.8 1.2-1.3 1.7-.6.6-2.2 1.7-4.7 3.3-.1 0-.2.1-.2.1-.2 0-.3-.1-.4-.2 0-.1-.1-.1-.1-.2V8.9c-1.2 0-2.3-.5-3.1-1.3C.4 6.8 0 5.7 0 4.6c0-1.3.4-2.4 1.3-3.2.9-1 2-1.4 3.3-1.4m4.6 7.6c.5-.4.8-.9 1.1-1.4.3-.5.4-1.1.4-1.6 0-1-.4-1.9-1.1-2.6C8.9 1.2 8 .9 7 .9H4.6C3.6.9 2.7 1.3 2 2 1.2 2.7.9 3.5.9 4.6c0 1 .3 1.8 1 2.5.7.6 1.6 1 2.6 1h.2c.2-.1.3-.1.4 0 .1.1.1.2.1.3v1.9c2.2-1.4 3.5-2.4 4-2.7"/></svg></a>

												<a href="<?php echo esc_url('https://twitter.com/intent/retweet?tweet_id=' . $twitter['id_str'] . '&related=' . $user['screen_name']);?>" title="Retweet" class="ekit-twitter-retweet"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 9.7"><path d="M4.2 8.8h3.4c.1 0 .2 0 .3.1.1.1.2.2.2.3 0 .1 0 .2-.1.3-.1.1-.2.2-.4.2H4.2c-.6 0-1.1-.2-1.5-.7-.4-.4-.6-.9-.6-1.5v-6L.8 2.8c-.1.1-.2.1-.4.1s-.2 0-.3-.1C0 2.7 0 2.6 0 2.5c0-.1 0-.2.1-.3l2-2c.2-.2.3-.2.4-.2.1 0 .2 0 .3.1l2.1 2c0 .2.1.3.1.4 0 .1 0 .2-.1.3-.1.1-.2.1-.4.1-.1 0-.2 0-.3-.1L2.9 1.5v6c0 .4.1.7.4.9.3.3.6.4.9.4m9.7-1.9c.1.1.1.2.1.3s0 .2-.1.3l-2 2c-.1.1-.2.1-.3.1-.1 0-.2 0-.3-.1l-2.1-2c-.1-.1-.2-.2-.2-.3s0-.2.1-.3c.1-.1.2-.1.3-.1s.2 0 .3.1L11 8.2v-6c0-.4-.1-.7-.4-.9-.2-.3-.5-.4-.8-.4H6.4c-.1 0-.2 0-.3-.1C6 .7 5.9.6 5.9.4c0-.1 0-.2.1-.3.1-.1.2-.1.4-.1h3.4c.6 0 1.1.2 1.5.6.4.4.6.9.6 1.5v6l1.3-1.3c.1-.1.2-.1.3-.1s.3.1.4.2"/></svg><strong><?php echo esc_attr($this->unit_converter($twitter['retweet_count']));?></strong> </a>

												<a href="<?php echo esc_url('https://twitter.com/intent/like?tweet_id=' . $twitter['id_str'] . '&related=' . $user['screen_name']);?>" title="Like" class="ekit-twitter-like"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14"><path d="M5.1 13.1c-.8-.6-1.5-1.3-2.3-2.2-.7-.9-1.4-1.9-2-3.1C.3 6.5 0 5.4 0 4.3s.4-2.1 1.1-3C1.9.4 2.8 0 3.8 0 5 0 6.1.7 7 2c.9-1.4 2-2 3.2-2 1 0 1.9.4 2.6 1.3.8.9 1.1 1.9 1.1 3s-.3 2.3-.8 3.5c-.6 1.2-1.2 2.3-2 3.1-.8.9-1.5 1.6-2.3 2.2-.7.6-1.3.9-1.8.9s-1.1-.3-1.9-.9m-3.2-11c-.6.6-.9 1.3-.9 2.2 0 .8.2 1.6.5 2.5.3.9.8 1.7 1.3 2.4s1 1.3 1.6 1.9c.6.6 1.1 1 1.5 1.3.5.3.8.5 1 .5.2 0 .6-.2 1-.5.5-.3 1-.8 1.5-1.3.6-.6 1.1-1.2 1.6-1.9s.9-1.5 1.3-2.4c.5-.9.7-1.7.7-2.5s-.3-1.6-.8-2.2c-.5-.6-1.2-.9-1.9-.9-.3 0-.6.1-1 .2-.3.1-.6.3-.8.5-.2.2-.4.4-.5.6-.2.3-.3.4-.4.6-.1.1-.1.2-.1.2-.1.2-.3.3-.5.3s-.4-.1-.5-.3c-.1-.2-.1-.3-.3-.5-.1-.1-.2-.4-.5-.7-.2-.3-.5-.5-.8-.7-.4-.2-.8-.3-1.1-.3-.8 0-1.4.3-1.9 1"/></svg><strong><?php echo esc_attr($this->unit_converter($twitter['favorite_count']));?></strong> </a>
											</div>
										<?php endif;?>
