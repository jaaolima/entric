                    ...
                    <div class="ekit-feed-header ekit-feed-header-dribble">
                        ...
                        <div class="header-left">
                            ...
                            <div class="ekit-feed-header--thumbnail">
                                ...
                                ?>
                                <img src="<?php echo esc_url($thumbnail) ?>" alt="<?php echo esc_attr($profile['title']) ?>">
                            </div>
                            <!-- End thumbnail -->
                            <div>
                        ...
                        <div class="header-right">
                            <div class="ekit-feed-header--actions">
                                <a href="<?php echo esc_url($profile['link']) ?>" target="_" class="btn btn-primary btn-pill">
                                    <?php echo esc_html__('Follow', 'elementskit') ?>
                                </a>
                                <a href="<?php echo esc_url($profile['link']) ?>" target="_" class="btn btn-primary-outlined btn-pill">
