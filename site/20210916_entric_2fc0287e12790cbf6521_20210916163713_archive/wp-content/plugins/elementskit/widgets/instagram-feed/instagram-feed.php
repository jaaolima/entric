...
class ElementsKit_Widget_Instagram_Feed extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        //     'ekit_instagram_feed_user_data',
        //     [
        //         'label' => esc_html('User data','elementskit'),
        //     ]
        // );

        // $this->add_control('ekit_instagram_feed_user_name',[
        //     'label' => __('Username','elementskit'),
        //     'type' => \Elementor\Controls_Manager::TEXT,
        //     'frontend_available' => true,
        //     'placeholder' => __('Public profile username')
        // ]);
    ...
    protected function render_raw()
    {
        ...
        $data = Handler::get_instagram_feed();
        if(!isset($data->data)){
          echo esc_html__('Data empty. Make sure you put correct credentials', 'elementskit') ;
          return;
        }
            ...
            <div class="ekit-insta-row <?php echo esc_attr($masnory_column . ' ' . $styleLayout . ' ' . $row_class); ?>">
                ...
                // if (isset($response->data) && sizeof($response->data)) :
                    ...
                    foreach ($data->data as $no => $ins_post) {
                        ...
                        $pic_src = '';
                        $pic_created_time = '';
                        // if (isset($ins_post->timestamp)) {
                        //     $pic_created_time = date("F j, Y", $ins_post->timestamp);
                            ...
                            <div class="ekit-insta-content-holder <?php if ($ekit_instagram_feed_style == 'yes') : ?>ekit-insta-style-tiles<?php endif; ?> <?php if ($ekit_instagram_feed_style != 'yes') : ?>ekit-insta-style-classic<?php endif; ?>">
                                <?php if (($ekit_instagram_feed_show_profile_header == 'yes') && ($ekit_instagram_feed_style != 'yes')) : ?>
                                    <div class="ekit-nsta-user-info">
                                        <a class="ekit-insta-user-details" href="https://www.instagram.com/<?php echo esc_html($userInfo); ?>">
                                            <?php if (in_array($ekit_instagram_feed_profile_settings, ['both', 'only-profile'])) : ?>
                                                <div class="ekit-insta-user-image <?php echo esc_attr($ekit_instagram_feed_show_profile_style); ?>">
                                                    <img src="" alt="<?php echo esc_html($userInfo); ?>">
                                                </div>
                                            <?php endif; ?>
                                ...
                                <div class="insta-media">
                                    ...
                                    <?php if($ins_post->media_type == 'VIDEO'): ?>
                                        ...
                                        ></video>
                                    <?php else: ?>
                                        <img class="img-responsive photo-thumb" src="<?php echo esc_url($pic_link); ?>" alt="<?php echo esc_html($userInfo); ?>">
                                    <?php endif; ?>
                                    </a>
                                </div>
