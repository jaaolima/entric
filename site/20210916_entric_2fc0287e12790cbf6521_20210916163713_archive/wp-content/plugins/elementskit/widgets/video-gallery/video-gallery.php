...
class ElementsKit_Widget_Video_Gallery extends Widget_Base {
    ...
    protected function render_raw( ) {
        ...
        $config = [
            ...
            'pauseOnHover'		=> $pause_on_hover == 'yes' ? true : false,
			'prevArrow'			=> $prevArrowIcon,
			'nextArrow'			=> $nextArrowIcon,
            'autoplay'			=> $autoplay == 'yes' ? true : false,
            'autoplaySpeed'		=> !empty($speed) ? $speed : 1000,
            'infinite'			=> $autoplay == 'yes' ? true : false,
            'slidesToShow'		=> !empty($slidetosho) ? $slidetosho['size'] : '',
            'slidesToScroll'	=> !empty($slidesToScroll) ? $slidesToScroll['size'] : '',
            'pauseOnHover'	    => $pause_on_hover == 'yes' ? true : false,
            'responsive'		=> [
                [
                    'breakpoint'    => 1024,
                    'settings'      => [
                        'slidesToShow'      => !empty($slidetosho_tablet) ? $slidetosho_tablet['size'] : '',
                        'slidesToScroll'    => !empty($slidesToScroll_tablet) ? $slidesToScroll_tablet['size'] : '',
                    ],
                ],
                [
                    'breakpoint'    => 480,
                    'settings'      => [
                        'slidesToShow'      => !empty($slidetosho_mobile) ? $slidetosho_mobile['size'] : '',
                        'slidesToScroll'    => !empty($slidesToScroll_mobile) ? $slidesToScroll_mobile['size'] : '',
                    ],
                    'arrows'		=> false,
                ]
            ],
		...
		?>
			<div class="ekit-video-gallery-wrapper">
                ...
                <div <?php echo \ElementsKit_Lite\Utils::render($this->get_render_attribute_string( 'wrapper' )); ?>>
                    ...
                    ?>
                        <div class="ekit-video-item <?php echo $this->slugify(esc_attr($video['video_category'])); ?>">
