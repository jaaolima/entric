                            ...
                            <div class="default-tab bordered-tab entric">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item tabsec tabhistoria">
                                        <a class="nav-link" data-toggle="tab" href="#historia">História Clínica</a>
                                    </li>
                                    <li class="nav-item tabsec tabavaliacao">
                                        <a class="nav-link" data-toggle="tab" href="#avaliacao">Avaliação<br>Nutricional</a>
                                    </li>
                                    <li class="nav-item tabsec tabnecessidades">
                                        <a class="nav-link" data-toggle="tab" href="#necessidades">Necessidades<br>Nutricionais</a>
                                    </li>
                                    <li class="nav-item tabsec tabcalculo">
                                        <a class="nav-link" data-toggle="tab" href="#calculo">Cálculo de Terapia<br>Nutricional</a>
                                    </li>
                                    <li class="nav-item tabsec tabobservacoes">
                                        <a class="nav-link" data-toggle="tab" href="#observacoes">Observações</a>
                                    </li>
                                    <li class="nav-item tabsec tabfornecedores">
                                        <a class="nav-link" data-toggle="tab" href="#fornecedores">Fornecedores</a>
                                    </li>
                                ...
                                <div class="tab-content tab-content-default">
                                    ...
                                    <?php require_once("index_fornecedores.php"); ?>
