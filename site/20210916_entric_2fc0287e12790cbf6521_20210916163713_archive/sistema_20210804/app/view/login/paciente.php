                                        ...
                                        <div class="card-body login-prescritor">
                                            ...
                                            <form class="mt-5 mb-5" action="login/paciente" method="post">
                                                ...
                                                <div class="input-group mb-5">
                                                    ...
                                                    <input type="password" name="codigo" class="form-control" placeholder="Digite o código de acesso" required="required">
                                                </div>
                                            ...
                                            <div class="text-center">
                                                <p class="mt-5 t-verde"><a href="javascript:void()" class="t-verde">Esqueceu o código de acesso?</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
