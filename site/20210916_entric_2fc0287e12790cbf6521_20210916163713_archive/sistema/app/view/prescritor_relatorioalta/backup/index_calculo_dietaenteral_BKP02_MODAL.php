...
<div class="modal fade" id="modal_dietaenteral" tabindex="-1" role="dialog" aria-labelledby="modal_dietaenteral" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="max-width: 80%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Dieta Enteral</h5>
