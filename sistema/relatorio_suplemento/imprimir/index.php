...
<iframe src="https://homologacao.entric.com.br/relatorio_suplemento/<?php echo $url;?>" id="relatorio" style="margin: 0px; padding: 0px; border: 0px; width: 100%; height: 100%;"></iframe>
