								...
								for ($m=0; $m < count($medida_dc); $m++) { 
		                            ...
		                            if ($margem_liberadas){
										...
										$retorno .= '<tr>
														...
														<td>'.$medida.'</td>
														<td name="porcao_'.$produtos[$i]['id'].'___'.$produtos[$i]['nome'].'___'.$medida.'___'.$medida_g[$m].'___'.$categoria.'">'.$medida_g[$m].'</td>
														<td name="total_dose_'.$produtos[$i]['id'].'___'.$produtos[$i]['nome'].'___'.$medida.'___'.$medida_g[$m].'___'.$categoria.'">'.$medida_g[$m].'</td>
														<td><input value="1" min="1" style="width:40px;text-align:center;" class="valor_porcao" data-id="'.$produtos[$i]['id'].'___'.$produtos[$i]['nome'].'___'.$medida.'___'.$medida_g[$m].'___'.$categoria.'" type="number"></td>
													</tr>';
										$titulo = "";
		                            }
		                            $cont_array = $cont_array+1;
