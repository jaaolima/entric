											...
											$retorno .= '<tr>
															<td>
																<div class="form-check col-sm-12">
																	...
																	<label for="produto_dc['.$produtos[$i]['id'].'___'.$produtos[$i]['nome'].'___'.$medida_dc[$m].'___'.$volume_dia.'___'.$volume_und.']" class="form-check-label check-green">'.$produtos[$i]['nome']."  ".$_nome.'<img src="../../../public/assets/images/bandeira.png" alt=""></label>
																</div>
		                                                	</td>
															<td>'.$medida_dc[$m].'</td>
															<td>'.$volume_und.'</td>
