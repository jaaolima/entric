		...
		if ($result) {
			...
			if ($usuario){
		        ...
		        $produtos = $db->select_to_array("produtos",
		                                            ...
		                                            "WHERE via = 'Enteral' and especialidade LIKE '%Adulto%' and (nome LIKE '%".$dados."%' OR apresentacao LIKE '%".$dados."%' OR fabricante LIKE '%".$dados."%' OR indicacao LIKE '%".$dados."%')", 
		                                            null);
	...
	$app->post("/ajax_stCalculo", function (Request $request, Response $response) {
		...
		if ($result) {
			...
			if ($usuario){
		        ...
		        if (!isset($dados['dieta_quantas_horas_ocorrer'])) $dados['dieta_quantas_horas_ocorrer'] = null;
		        ...
		        $bind = array(  $campo_prescritor => $id_prescritor,
		                        ...
		                        ':dieta_quantas_horas_ocorrer' => array_json($dados["dieta_quantas_horas_ocorrer"], false),
		                        ...
		                        ':modulo_diluir_anterior' => array_json($dados["modulo_diluir_anterior"], false),
		                        ...
		                        ':suplemento_densidade' => array_json($dados["suplemento_densidade"], false) ,
		                        ':suplemento_diluicao' => array_json($dados["suplemento_diluicao"], false) ,
		                        ':suplemento_volume_final' => array_json($dados["suplemento_volume_final"], false) ,
		                        ':hora_correr' => array_json($dados["hora_correr"], false) ,
