...
class Database_ibranutro{
    ...
    public function connect(){
        if(!$this->con){
            try {
                $myconn = new PDO("mysql:host=157.230.57.123;dbname=ibranutro;charset=utf8;port=3306", 'ibranutro', 'd@y!r9GhF5quaKbz');         
    ...
    public function select_single_to_array($tables, $fields = '*', $conds = null, $bind = null) {
        ...
        var_dump($tables, $fields, $conds, $bind);
