	...
	public function render_header() {
		...
		<div <?php echo $this->get_render_attribute_string( 'carousel' ); ?>>
			<div <?php echo $this->get_render_attribute_string( 'wc-carousel' ); ?>
				...
				data-responsive-settings='{"ekit_columns_desktop": "<?php echo $settings['ekit_columns_desktop'] ? esc_attr($settings['ekit_columns_desktop']) : 4;?>", "ekit_columns_tablet": "<?php echo $settings['ekit_columns_tablet'] ? esc_attr($settings['ekit_columns_tablet']) : 3 ;?>", "ekit_columns_mobile": "<?php echo $settings['ekit_columns_mobile'] ? esc_attr($settings['ekit_columns_mobile']) : 1;?>"}'
			>
