		...
		<p>
			<table width="100%" cellspacing="0" cellpadding="0">
				<tbody>
					...
					<tr>
						<td style="width:  100%; border-left: 0px solid #8fcfe5; text-align: center;display:flex;font-size:11px;padding-top:10px;display:flex;flex-wrap:wrap;justify-content:space-between;">
							<?php 
