...
<iframe src="https://sis.entric.com.br/relatorio_simplificada/<?php echo $url;?>" id="relatorio" style="margin: 0px; padding: 0px; border: 0px; width: 100%; height: 100%;"></iframe>
