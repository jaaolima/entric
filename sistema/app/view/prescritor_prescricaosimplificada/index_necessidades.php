    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <form action="prescritor_relatorioalta" method="post" autocomplete="off" onsubmit="return false">   
                <input type="hidden" name="action" value="necessidades"/>
                ...
                <div class="entric_necessidades">
                    ...
                    <div class="row b_ltrb">
                        <div class="col-lg-3 b_r ln-40">
                            <select id="nec_calorias_peso" name="nec_calorias_peso" aria-controls="nec_calorias_peso" class="form-control input-sm mt-3 calorias_total">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" placeholder="" readonly="readonly" name="nec_calorias_peso_valor" id="nec_calorias_peso_valor" class="form-control necessidades_peso">
                            ...
                            <div class="default-tab bordered-tab entric">
                                <ul class="nav nav-tabs tabcalorias" role="tablist">
                                    <li class="nav-item col-6">
                                        <a class="nav-link acalorias active" data-toggle="tab" href="#formula_bolso">Fórmula de Bolso</a>
                                    </li>
                                    <li class="nav-item col-6">
                                        <a class="nav-link acalorias" data-toggle="tab" href="#harris_benedict">Harris Benedict</a>
                                    </li>
                                </ul>
                                <div class="tab-content tab-content-default">
                                    <input type="hidden" name="tab_calorias" id="tab_calorias" value="#formula_bolso"/>
                                    <div class="tab-pane fade show active" id="formula_bolso" role="tabpanel">
                                        <div class=" d-flex justify-content-center align-middle">
                                            <center class="col-11 mt-3 ">
                                                <input type="number" name="formula_valor" id="formula_valor" data-suffix="kcal/kg" class="plusminus calorias_total" value="" data-decimals="0" min="0" max="99" step="1"/>
                                            </center>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="harris_benedict" role="tabpanel">
                                        Fator Atividade:
                                        <select id="fator_atividade_valor" name="fator_atividade_valor" aria-controls="fator_atividade_valor" class="form-control input-sm bd-cinza mb-3 calorias_total">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <select id="fator_injuria_tipo" name="fator_injuria_tipo" aria-controls="fator_injuria_tipo" class="form-control input-sm bd-cinza mb-3 calorias_total">
                                                    <option value="">selecione...</option>
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" placeholder="" required="required" name="fator_injuria_valor" id="fator_injuria_valor" class="form-control medianota calorias_total">
                                            </div>
                                        </div>

                                        Fator Térmico:
                                        <select id="fator_termico_valor" name="fator_termico_valor" aria-controls="fator_termico_valor" class="form-control input-sm bd-cinza mb-3 calorias_total">
                                            <option value="">selecione...</option>
                        ...
                        <div class="col-lg-3 bg-cinza">
                            ...
                            <div class="row b_t">
                                <div class="col-lg-12 mt-3 text-center ln-40 text-azulescuro">
                                   <input type="text" readonly="readonly" name="nec_calorias_total" id="nec_calorias_total" class="form-control input-total" value="(kcal/kg)"> 
                                   <input type="text" readonly="readonly" name="nec_calorias_total2" id="nec_calorias_total2" class="form-control input-total none" value="(kcal/kg)"> 
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="entric_necessidades">
                    ...
                    <div class="row b_ltrb">
                        <div class="col-lg-3 b_r ln-40">
                            <select id="nec_proteinas_peso" name="nec_proteinas_peso" aria-controls="nec_proteinas_peso" class="form-control input-sm mt-3 mb-3 proteinas_total">
                                <option value="">Informe o valor do peso</option>
                                <option value="Peso ideal">Peso ideal</option>
                                <option value="Peso aferido">Peso aferido</option>
                                <option value="Peso usual">Peso usual</option>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" placeholder="" readonly="readonly" name="nec_proteinas_peso_valor" id="nec_proteinas_peso_valor" class="form-control proteinas_total necessidades_peso">
                                <div class="input-group-append">
                                    <span class="input-group-text">kg</span>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 b_r d-flex justify-content-center align-middle">
                            <center class="col-10 mt-3">
                                <input type="number" maxlength="3" name="proteinas_valor" id="proteinas_valor" data-suffix="g/kg" class="plusminus_ptn floatcomma proteinas_total" value="" data-decimals="1" min="0" max="9.9" step="0.1"/>
                            </center>
                        </div>
                        <div class="col-lg-3">
                            <div class="row">
                            ...
                            <div class="row b_t bg-cinza">
                                <div class="col-lg-12 mt-3 text-center ln-40 text-azulescuro">
                                   <input type="text" readonly="readonly" name="nec_proteinas_total" id="nec_proteinas_total" class="form-control input-total" value="(g/kg)"> 
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="entric_necessidades">
                    ...
                    <div class="row b_ltrb">
                        <div class="col-lg-3 b_r ln-40">
                            <select id="nec_agua_peso" name="nec_agua_peso" aria-controls="nec_agua_peso" class="form-control input-sm mt-3 mb-3 agua_total">
                                <option value="">Informe o valor do peso</option>
                                <option value="Peso ideal">Peso ideal</option>
                                <option value="Peso aferido">Peso aferido</option>
                                <option value="Peso usual">Peso usual</option>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" placeholder="" readonly="readonly" name="nec_agua_peso_valor" id="nec_agua_peso_valor" class="form-control necessidades_peso agua_total">
                                <div class="input-group-append">
                                    <span class="input-group-text">kg</span>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 b_r d-flex justify-content-center align-middle">
                            <center class="col-10 mt-3">
                                <input type="number" name="agua_valor" id="agua_valor" class="plusminus agua_total" data-suffix="ml/kg" value="" data-decimals="0" min="0" max="99" step="1"/>
                            </center>
                        </div>
                        <div class="col-lg-3">
                            <div class="row">
                            ...
                            <div class="row b_t bg-cinza">
                                <div class="col-lg-12 mt-3 text-center ln-40 text-azulescuro">
                                   <input type="text" readonly="readonly" name="nec_agua_total" id="nec_agua_total" class="form-control input-total" value="(ml/kg)"> 
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group row pt-5">
                    <div class="col-sm-6 text-left">
                        <button type="button" class="btn btn-secondary btn-sm" id="necessidades_salvar">
