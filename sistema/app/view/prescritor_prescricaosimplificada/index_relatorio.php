        ...
        <div class="col-sm-6">
            <form action="prescritor_relatorioalta" class="tab_relatorio_checkbox" method="post" autocomplete="off" onsubmit="return false">   
                ...
                <div class="row entric_group_radio border-0 mt-4 mb-2">
                    ...
                    <div class="form-group col-sm-2 mb-3">
                        <div class="form-check entric_radio pl-0 text-center">
                            <input id="rel_identificacao" style="cursor: default;background-color: light-dark(rgba(239, 239, 239, 0.3), rgba(59, 59, 59, 0.3));color: light-dark(rgb(84, 84, 84), rgb(170, 170, 170));" value="Identificação do Paciente" class="form-check-input styled-checkbox" type="checkbox" checked="checked">
