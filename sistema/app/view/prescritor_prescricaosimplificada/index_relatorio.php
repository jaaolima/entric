        ...
        <div class="col-sm-6">
            <form action="prescritor_relatorioalta" class="tab_relatorio_checkbox" method="post" autocomplete="off" onsubmit="return false">   
                ...
                <div class="row entric_group_radio border-0 mt-4 mb-2">
                    ...
                    <div class="form-group col-sm-2 mb-3">
                        <div class="form-check entric_radio pl-0 text-center">
                            <input disabled id="rel_identificacao" value="Identificação do Paciente" class="form-check-input styled-checkbox" type="checkbox" checked="checked">
                            <input name="rel_identificacao" value="Identificação do Paciente" class="form-check-input styled-checkbox" type="hidden" checked="checked">
