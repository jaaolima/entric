                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1"> 
                                ...
                                <input type="number" placeholder="kcal/kg" required="required" id="kcal_kg" name="kcal_kg" class="form-control div_calculo" value="" max='99'> 
                                <input type="number" readonly placeholder="kcal/dia" required="required" id="kcal_dia" name="kcal_dia" class="form-control" value="" max='9999'> 
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1"> 
                                ...
                                <input type="number" placeholder="g/kg" required="required" id="proteina_kg" name="proteina_kg" class="form-control div_calculo" value="" max='9,9'> 
                                <input type="number" readonly placeholder="g/dia" required="required" id="proteina_dia" name="proteina_dia" class="form-control" value="" max='999'> 
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1"> 
                                ...
                                <input type="number" placeholder="ml/kg" required="required" id="agua_kg" name="agua_kg" class="form-control div_calculo" value="" max='99'> 
                                <input type="number" readonly placeholder="ml/dia" required="required" id="agua_dia" name="agua_dia" class="form-control" value="" max='9999'> 
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1"> 
                                ...
                                <input type="number" placeholder="kcal/kg" required="required" id="up_kcal_kg" name="up_kcal_kg" class="form-control div_calculo_atualizar" value="" max='99'> 
                                <input type="number" readonly placeholder="kcal/dia" required="required" id="up_kcal_dia" name="up_kcal_dia" class="form-control" value="" max='9999'> 
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1"> 
                        ...
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1"> 
                                ...
                                <input type="number" placeholder="ml/kg" required="required" id="up_agua_kg" name="up_agua_kg" class="form-control div_calculo_atualizar" value="" max='99'> 
                                <input type="number" readonly placeholder="ml/dia" required="required" id="up_agua_dia" name="up_agua_dia" class="form-control" value="" max='9999'> 
                            </div>
                        </div>
                        <div class="text-center col-sm-12 mt-4">
