...
if ($_SESSION['paciente_redirect']['buscar'] == 'buscar') {
    ...
    $_SESSION['paciente_redirect']['buscar'] = '';
...
<div class="tab-pane fade show active" id="cadastro" role="tabpanel">
    <div class="pt-3">
        ...
        <div class="text-center">
            ...
            <button type="button" onclick="rangeCaloria(2400);"
                class="btn <?php echo ($tab1 == "cadastrar" ? "btn-warning" : "btn-secondary"); ?> btn-sm"
                id="cadastrar_paciente">
                <span class="btn-icon-right"><i class="fa fa-user"></i></span>
                CADASTRAR PACIENTE
            </button>
            &nbsp;
            <button type="button" class="btn <?php echo ($tab1 == "buscar" ? "btn-warning" : "btn-secondary"); ?> btn-sm"
                id="buscar_paciente">
        ...
        <div id="div_cadastrar_paciente" style="<?php echo ($tab1 == "cadastrar" ? "display: block;" : "display: none;"); ?>">
            <form action="prescritor_relatorioalta" id="form_cadastrar_paciente" method="post" autocomplete="off"
                ...
                if (($sistema == 'EN2' || $sistema == 'ibranutro') || $_SESSION['login'] == 'ibranutro') {
                    ...
                    $campo_hospital = array("col" => 4, "label" => "Hospital:", "value" => $ds_hospital, "select" => $hospitais_select_por_nome, $readonly => true);
                } else {
                    ...
                    <div class="col-md-4">
                        <div class="col-md-12" name='div_calculo'>
                            <div class="w-100 mb-2"
                                style="display: inline-block;text-align: end;white-space: nowrap;vertical-align: middle;padding: .7rem 1.8rem;font-size: 12px !important;border-radius: 5px;background: #eda349;border-color: #eda349;color: #fff;">
                                <span>Total</span>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1">
                                ...
                                <input type="text" placeholder="kcal/kg" required="required" id="kcal_kg" name="kcal_kg"
                                    class="form-control div_calculo" value="">
                                <input type="text" readonly placeholder="kcal/dia" required="required" id="kcal_dia"
                                    name="kcal_dia" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1">
                                ...
                                <input type="text" placeholder="g/kg" required="required" id="proteina_kg"
                                    name="proteina_kg" class="form-control div_calculo" value="">
                                <input type="text" readonly placeholder="g/dia" required="required" id="proteina_dia"
                                    name="proteina_dia" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1">
                                ...
                                <input type="text" placeholder="ml/kg" required="required" id="agua_kg" name="agua_kg"
                                    class="form-control div_calculo" value="">
                                <input type="text" readonly placeholder="ml/dia" required="required" id="agua_dia"
                                    name="agua_dia" class="form-control" value="">
                            </div>
                        </div>
        ...
        <div id="div_buscar_paciente" style="<?php echo ($tab1 == "buscar" ? "display: block;" : "display: none;"); ?>">
            <div id="listar_pacientes" style="display: none;">
                <form action="prescritor_relatorioalta" id="form_atualizar_paciente" method="post" autocomplete="off"
                    onsubmit="return false">
                    ...
                    <div class="form-group row pt-5">
                        <div class="col-sm-6 text-right">
                            <button type="button" onclick="fc_limpar_paciente();"
                                class="btn btn-secondary btn-form">VOLTAR</button>
                        </div>
                        <div class="col-sm-6 text-left">
                            <button type="submit" onclick="fc_atualizar_paciente();"
                                class="btn btn-warning btn-form">Atualizar</button>
                        </div>
                    </div>
                </form>
                ...
                <div class="form-group row pt-5">
                    <div class="col-sm-6 text-left">
                        <button type="button" onclick="window.location.href='prescritor_prescricaosimplificada'"
                            class="btn btn-secondary btn-form">VOLTAR</button>
                    </div>
                    <div class="col-sm-6 text-right">
                        <button type="button" class="btn btn-warning btn-form" id="gerar_relatorio">GERAR NOVO
                            RELATÓRIO</button>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1">
                                ...
                                <input type="text" placeholder="kcal/kg" required="required" id="up_kcal_kg"
                                    name="up_kcal_kg" class="form-control div_calculo_atualizar" value="">
                                <input type="text" readonly placeholder="kcal/dia" required="required" id="up_kcal_dia"
                                    name="up_kcal_dia" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1">
                                ...
                                <input type="text" placeholder="g/kg" required="required" id="up_proteina_kg"
                                    name="up_proteina_kg" class="form-control div_calculo_atualizar" value="">
                                <input type="text" readonly placeholder="g/dia" required="required" id="up_proteina_dia"
                                    name="up_proteina_dia" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group input-group mb-1">
                                ...
                                <input type="text" placeholder="ml/kg" required="required" id="up_agua_kg"
                                    name="up_agua_kg" class="form-control div_calculo_atualizar" value="">
                                <input type="text" readonly placeholder="ml/dia" required="required" id="up_agua_dia"
                                    name="up_agua_dia" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="text-center col-sm-12 mt-4" id="div_botao_cadastrar_relatorio"
                            style="display:none;">
            ...
            <div id="buscar_pacientes" class="display: block;">
                <form action="prescritor_relatorioalta" id="prescritor_relatorioalta" name="prescritor_relatorioalta"
                    ...
                    <div class="modal fade" id="modal_retorno_pacientes" tabindex="-1" role="dialog"
                        aria-labelledby="modal_retorno_pacientes" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-clique"
                                            id="table_retorno_pacientes">
                                            <thead>
                                                <tr>
                    ...
                    <div class="form-group row pt-5">
                        <div class="col-sm-12 text-center">
                            <button type="submit" onclick="fc_buscar_paciente();"
                                class="btn btn-secondary btn-form">BUSCAR</button>
                        </div>
                    </div>
                </form>
            </div>
