            ...
            $.each(dados_json.relatorios, function(i, item) {
                ...
                if (item.status == 1){
                    ...
                    if(item.codigo == null){
                        ...
                        var editar = '<a target="_blank" href="https://entric.com.br/relatorio_simplificada/'+item.relatorio_code+'"><i class="fa fa-file-text-o"></i></a>';
                    }
                }
...
function check_dieta(_this, diluicao_id){
    ...
    if($(_this).hasClass("check_dieta")){
        let tbody = $(this).closest("tbody"); // Obtém o tbody correspondente
        console.log(tbody);
...
$(function(){
    ...
    $("#rel_imprimir_relatorio").on("click", function(e) {        
        var relatorio_code = $("#relatorio_code").val();
        window.open("https://entric.com.br/relatorio_simplificada/imprimir/?url="+relatorio_code, "_blank");
    });
