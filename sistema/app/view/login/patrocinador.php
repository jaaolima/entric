            ...
            <div class="row justify-content-between h-100">
                ...
                <div class="col-xl-5">
                    <div class="row h-100 justify-content-center align-items-center bg-login">
                        <a href="login">
                            <img src="assets/images/login-logo.png" border="0" width="250" />
                        </a>
                    </div>
                </div>
                                ...
                                <div class="form-input-content login-form bg-white">
                                    <div class="card">
                                        <div class="card-body login-prescritor">
                                            <h4 class="text-center mt-4 t-verde line-bottom pb-4">Patrocinador, seja bem-vindo!</h4>
                                            <form class="mt-5 mb-5" action="login/patrocinador" method="post">
                                                <input type="hidden" name="_token" value="<?php echo generateFormToken('loginPatrocinador'); ?>">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="login" class="form-control" placeholder="Login" value="patrocinador@patrocinador.com" required="required">
                                                </div>
                                                ...
                                                <div class="input-group mb-5">
                                                    ...
                                                    <input type="password" name="senha" class="form-control" placeholder="Senha" value="patrocinador" required="required">
                                                </div>
                                            ...
                                            <div class="text-center">
                                                <p class="mt-5 t-verde"><a href="senha/patrocinador" class="t-verde">Esqueceu a senha?</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
