                                ...
                                <div class="form-input-content login-form bg-white">
                                    <div class="card">
                                        <div class="card-body login-prescritor">
                                            <h4 class="text-center mt-4 t-verde line-bottom pb-4">Seja bem-vindo!</h4>
                                            <form class="mt-5 mb-5" action="login/paciente" method="post">
                                                <input type="hidden" name="_token" value="<?php echo generateFormToken('loginPaciente'); ?>">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="login" class="form-control" placeholder="E-mail" value="" required="required">
                                                </div>
                                                ...
                                                <div class="input-group mb-5">
                                                    ...
                                                    <input type="password" name="senha" class="form-control" placeholder="Senha" value="" required="required">
                                                </div>
                                            ...
                                            <div class="row text-center">
                                                <div class="col-md-12">
                                                    <p class="mt-3 t-verde pull-center"><a href="senha/paciente" class="t-verde">Esqueceu a senha?</a></p>
                                                </div>
                                            </div>
                                            <div class="row text-center">
                                                <div class="col-md-12">
                                                    <small class="mt-5">Esta área é exclusiva para pacientes ou acompanhantes que receberam uma prescrição nutricional. Consulte seu e-mail para verificar seu link de cadastro.</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
