                                ...
                                <div class="row">
                                    <div class="col-6 p-4">
                                        <div class="form-check col-sm-12">
                                            ...
                                            <label for="filtro_categoria_modulo_proteina" class="form-check-label radio-green">Proteína</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            ...
                                            <label for="filtro_categoria_modulo_colageno_aminoacidos" class="form-check-label radio-green">Colágeno ou Aminoácidos</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            ...
                                            <label for="filtro_categoria_modulo_carboidrato" class="form-check-label radio-green">Carboidrato</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            ...
                                            <label for="filtro_categoria_modulo_lipideo" class="form-check-label radio-green">Lipídeo</label>
                                        </div>
                                    </div>
                                    <div class="col-6 p-4">
                                        <div class="form-check col-sm-12">
                                            ...
                                            <label for="filtro_categoria_modulo_fibras" class="form-check-label radio-green">Fibras</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            ...
                                            <label for="filtro_categoria_modulo_probioticos" class="form-check-label radio-green">Probióticos</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            ...
                                            <label for="filtro_categoria_modulo_simbioticos" class="form-check-label radio-green">Simbióticos</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            ...
                                            <label for="filtro_categoria_modulo_espessante" class="form-check-label radio-green">Espessante</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
