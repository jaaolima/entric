<div class="modal fade" id="modal_fabricantes" role="dialog" aria-labelledby="modal_fabricantes" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Fabricantes</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="pull-right pb-3">
                    <button type="button" class="btn btn-secondary btn-form" onclick="modalFabricantesCadastrar();">Cadastrar</button>
                </div>
