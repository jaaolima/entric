    ...
    $.ajax({
        ...
        success: function( dados ){
            ...
            jQuery.each(dados.rm, function(i,data) {
                _table.append("<tr><td>" + data + "</td><td class='text-center'><button onclick='modalFabricantesEditar(\""+ data +"\");' class='btn-sm text-info'><i class='fa fa-pencil' aria-hidden='true'></i></button> <a href='javascript:modalFabricantesDelete(\""+ data +"\");' class='btn-sm text-danger'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td></tr>");
            });
