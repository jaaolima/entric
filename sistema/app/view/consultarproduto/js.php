    ...
    $.ajax({
        ...
        success: function( dados ){
            ...
            jQuery.each(dados.rm, function(i,data) {
                console.log(data);
                console.log(_table.find("tbody").html());
                _table.find("tbody").append("<tr><td>" + data + "</td><td class='text-center'><a href='javascript:modalFabricantesEditar("+ data +");' class='btn-sm text-info'><i class='fa fa-pencil' aria-hidden='true'></i></a> <a href='javascript:modalFabricantesDelete("+ data +");' class='btn-sm text-danger'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td></tr>");
            });
