    ...
    $.ajax({
        ...
        success: function( dados ){
            ...
            jQuery.each(dados.rm, function(i,data) {
                _table.append("<tr><td>" + data + "</td><td class='text-center'><a href='javascript:modalFabricantesEditar(\""+ data +"\");' class='btn-sm text-info'><i class='fa fa-pencil'></i></a> <a href='javascript:modalFabricantesDelete(\""+ data +"\");' class='btn-sm text-danger'><i class='fa fa-trash-o'></i></a></td></tr>");
            });
