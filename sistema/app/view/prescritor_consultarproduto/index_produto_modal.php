            ...
            <div class="modal-body">
                <form role="form" id="modalfrmproduto" name="modalfrmproduto" onsubmit="return false">
                    ...
                    <div class="row">
                            ...
                            <div id="m_apresentacao_oral" class="row entric_grid mt-4 m-0 p-0 none">
                                ...
                                <div class="form-group col-sm-9">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-check">
                                            <input id="m_calculo_oral_omega3" name="m_carac_oral[]" class="form-check-input styled-checkbox" type="checkbox" value="Com óleo de peixe">
                                ...
                                $item_dados =  $html->addRow(
                                                array(
                                                    "m_div_indicacao" => array(
                                                        "form-class" => "m_div_indicacao mb-1 Pplr12",
                                                        "col" => 6,
                                                        "type" => "div",
                                                        "content" => $html->addRow(
                                                                array(
                                                        ...
                                                        "content" => $html->addRow(
                                                                     array(
                                                                        ...
                                                                        "composicao_nutricional" => array(
                                                                            ...
                                                                            "type" => "div",
                                                                            "content" =>'<div class="entric_composicao comp_nutricional entric_compo p-2" style="background-color: #ffffff;">
                        ...
                        <div class="col-sm-4 entric_composicao pt-2 info_nutricionais">
