<div class="tab-pane fade" id="tabfiltros" role="tabpanel">
    <div class="pt-0">
        ...
        <div class="default-tab bordered-tab entric">
            <form role="form" id="frmfiltroproduto" name="frmfiltroproduto" onsubmit="return false" class="bg-azul">
                <div class="row">

                    <div class="col-sm-12 bg-azul-row">
                        <div class="row equal-cols search_chg">
                            <div class="form-group col-sm-3 mb-0 plr-12">
                                <div class="entric_group entric_cat p-3">
                                    <div class="form-radio entric_radio2">
                                        <div class="form-check">
                                            <label class="grid_label">Fabricante</label>
                                        </div>
                                        <select id="filtro_fabricante" name="filtro_fabricante" aria-controls="filtro_fabricante" class="form-control input-sm select-tag">
                                            <?php
                                            if ($fornecedores){
                            ...
                            <div class="form-group col-sm-4 mb-0 plr-12">
                                <div class="entric_group entric_cat p-3">
                                    <div class="form-check">
                            ...
                            <div class="form-group col-sm-5 mb-0 plr-12">
                                <div class="entric_group entric_cat p-3">
                                    <div class="form-check">
                                    ...
                                    <div class="row p-4">
                                        <div class="col-sm-4">
                                            <div class="form-radio">
                                                <input id="filtro_calculo_via_enteral" checked class="radio-outlined" name="via" type="radio" value="Enteral">
                        ...
                        <div id="filtro_apresentacao_enteral" class="row entric_grid mt-4 m-0 p-0 search_chg search_Enteral">
                        ...
                        <div id="filtro_apresentacao_oral" class="row entric_grid mt-4 m-0 p-0 none search_chg search_Oral">
                            <div class="form-group col-sm-3 mb-0">
                                <div class="form-check">
                                    <label class="grid_label">Apresentação</label>
                                </div>
                            ...
                            <div class="form-group col-sm-9 filtros_oral mb-0">
                                <div class="form-check">
                                    <label class="grid_label">Filtros</label>
                                </div>
                                <div class="row p-4"> 
                        ...
                        <div id="filtro_apresentacao_modulo" class="row entric_grid entric_filtrogrid entric_filtrogridapres mt-4 m-0 p-0 none search_chg search_Modulo">
                            <div class="form-group col-12">
                                ...
                                <div class="row">
                                    <div class="col-6 p-4">
                                        ...
                                        <div class="form-check col-sm-12">
                                            <input id="filtro_categoria_modulo_carboidrato" name="cat_modulo[]" class="form-check-input styled-checkbox" type="checkbox" value="Carboidrato">
                                            <label for="filtro_categoria_modulo_carboidrato" class="form-check-label check-green">Carboidrato</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            <input id="filtro_categoria_modulo_lipideo" name="cat_modulo[]" class="form-check-input styled-checkbox" type="checkbox" value="Lipídeo">
                                            <label for="filtro_categoria_modulo_lipideo" class="form-check-label check-green">Lipídeo</label>
                                        </div>
                                    </div>
                                    <div class="col-6 p-4">
                                        <div class="form-check col-sm-12">
                                            <input id="filtro_categoria_modulo_fibras" name="cat_modulo[]" class="form-check-input styled-checkbox" type="checkbox" value="Fibras">
                                            <label for="filtro_categoria_modulo_fibras" class="form-check-label check-green">Fibras</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            <input id="filtro_categoria_modulo_probioticos" name="cat_modulo[]" class="form-check-input styled-checkbox" type="checkbox" value="Probióticos">
                                            <label for="filtro_categoria_modulo_probioticos" class="form-check-label check-green">Probióticos</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            <input id="filtro_categoria_modulo_simbioticos" name="cat_modulo[]" class="form-check-input styled-checkbox" type="checkbox" value="Simbióticos">
                                            <label for="filtro_categoria_modulo_simbioticos" class="form-check-label check-green">Simbióticos</label>
                                        </div>
                                        <div class="form-check col-sm-12">
                                            <input id="filtro_categoria_modulo_espessante" name="cat_modulo[]" class="form-check-input styled-checkbox" type="checkbox" value="Espessante">
                                            <label for="filtro_categoria_modulo_espessante" class="form-check-label check-green">Espessante</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table id="filtro_resultado_dados" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="border-top-0">Nome</th>
