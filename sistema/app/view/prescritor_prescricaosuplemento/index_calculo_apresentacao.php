    <div class="row entric_grid mt-0 m-0 p-0 inputs1" id="apresentacao">
        ...
        <div class="form-group col-sm-8 btrbl apres_oral filtros_oral">
            ...
            <div class="row p-4">
                ...
                <div class="form-check col-sm-3">
                    <input id="calculo_oral_carac_normocalorico" name="carac_oral[]" class="form-check-input styled-checkbox filtro_1" type="checkbox" value="Normocalórico">
                    <label for="calculo_oral_carac_normocalorico" class="form-check-label check-green">Normocalórico(0,9 a 1,2 kcal/ml)</label>
                </div>
                <div class="form-check col-sm-3">
                ...
                <div class="form-check col-sm-3">
                    <input id="calculo_oral_carac_hipercalorico" name="carac_oral[]" class="form-check-input styled-checkbox filtro_1" type="checkbox" value="Hipercalórico">
                    <label for="calculo_oral_carac_hipercalorico" class="form-check-label check-green">Hipercalórico ( > 1,2 kcal/ml)</label>
                </div>
                <div class="form-check col-sm-3">
