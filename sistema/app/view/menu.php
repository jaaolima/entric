...
if (!isset($bruker->type)){
    ...
    <ul class="metismenu" id="menu">
        ...
        <li class="mega-menu mega-menu-lg"> 
            <a href="paciente_distribuidores"><img src="assets/images/icones/icon-fornecedores.png" border="0"><span class="nav-text">Pontos de Venda</span></a>
        </li>
    </ul>
    <?php
}
    ...
    if ($bruker->type == "administrador"){
        ...
        */
        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="mega-menu mega-menu-lg">
                <a href="distribuidores"><img src="assets/images/icones/icon-fornecedores.png" border="0"><span class="nav-text">Pontos de Venda</span></a>
            </li>        
            <li class="mega-menu mega-menu-lg">
        ...
        */
        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="mega-menu mega-menu-lg">
                <a href="prescritor_fornecedores"><img src="assets/images/icones/icon-fornecedores.png" border="0"><span class="nav-text">Pontos de Venda</span></a>
            </li> 
        </ul>
        <?php
