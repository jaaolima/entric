                                ...
                                <div class="form-input-content login-form bg-white">
                                    <div class="card">
                                        <div class="card-body login-prescritor">
                                            <h4 class="text-center mt-4 t-verde line-bottom pb-4">Prescritor, não conseguiu entrar?</h4>
                                            <form class="mt-5 mb-5" action="senha/prescritor" method="post">
                                                <input type="hidden" name="_token" value="<?php echo generateFormToken('senhaPrescritor'); ?>">
                                            ...
                                            <div class="text-center">
                                                <p class="mt-5 t-verde pull-left"><a href="login/prescritor" class="t-verde">Efetuar Login</a></p>
                                                <p class="mt-5 t-verde pull-right"><a href="cadastro/prescritor" class="t-verde">Cadastre-se</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
