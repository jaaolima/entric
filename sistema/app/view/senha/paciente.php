                                ...
                                <div class="form-input-content login-form bg-white">
                                    <div class="card">
                                        <div class="card-body login-prescritor">
                                            ...
                                            <form class="mt-5 mb-5" action="senha/paciente" method="post">
                                                <input type="hidden" name="_token" value="<?php echo generateFormToken('senhaPaciente'); ?>">
                                            ...
                                            <div class="text-center">
                                                <p class="mt-5 t-verde pull-center"><a href="login/paciente" class="t-verde">Efetuar Login</a></p>
