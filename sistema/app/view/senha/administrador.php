                                ...
                                <div class="form-input-content login-form bg-white">
                                    <div class="card">
                                        <div class="card-body login-prescritor">
                                            <h4 class="text-center mt-4 t-verde line-bottom pb-4">Administrador, não conseguiu entrar?</h4>
                                            <form class="mt-5 mb-5" action="senha/administrador" method="post">
                                                <input type="hidden" name="_token" value="<?php echo generateFormToken('senhaAdministrador'); ?>">
                                            ...
                                            <div class="text-center">
                                                <p class="mt-5 t-verde"><a href="login/administrador" class="t-verde">Efetuar Login</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
