            ...
            $.each(dados_json.relatorios, function(i, item) {
                ...
                if (item.status == 1){
                    ...
                    if(item.codigo == null){
                        ...
                        var editar = '<a target="_blank" href="https://homologacao.entric.com.br/relatorio_modulo/'+item.relatorio_code+'"><i class="fa fa-file-text-o"></i></a>';
                    }
                }
...
$(function(){
    ...
    $("#rel_imprimir_relatorio").on("click", function(e) {         
        var relatorio_code = $("#relatorio_code").val();
        window.open("https://homologacao.entric.com.br/relatorio_modulo/imprimir/?url="+relatorio_code, "_blank");
