...
if ((!startsWith($url,"login")) and (!startsWith($url,"logout")) and (!startsWith($url,"v/")) and (!startsWith($url,"senha")) and (!startsWith($url,"cadastro/"))  and (!startsWith($url,"paciente_videosalta"))  and (!startsWith($url,"paciente_distribuidores")) and (!startsWith($url,"login/loginDireto")) and (!startsWith($url,"senha/nova_prescritor"))) {    
    checkLoginSession();
}
